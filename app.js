        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ig.account.login(process.env.YOUR_USERNAME, process.env.PASSWORD)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                element = thread.broadcastText('enter text/message');
